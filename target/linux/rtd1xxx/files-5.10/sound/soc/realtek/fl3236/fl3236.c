...
/*
 * FL3236 SPI driver
 * Copyright (c) 2018-2020 YH HSIEH <yh_hsieh@realtek.com>
 */
...
int voice_direction_from_user;
int fl3236_check_flag;
...
static void convert_mic_position_to_led_position(int voice_direction)
{
	...
	if (voice_direction > 0 && voice_direction <= 30) {
		...
		pr_info("unknown voice position:%d\r\n", voice_direction);
			...
			const struct i2c_device_id *id)
{
	...
	fl3236->regmap = devm_regmap_init_i2c(i2c, &fl3236_regmap);
