...
enum {
	...
	HDCP_SET_22_CIPHER, /* Abandoned */
	HDCP_CONTROL_22_CIPHER, /* Abandoned */
	HDCP_SET_22_REPEATER_INFO, /* Abandoned */
	HDCP_SET_PARAM_KEY,
};
...
#define HDCP_GEN_AN_ERROR       8
#define HDCP_BKSV_ERROR         9
#define HDCP_R0_ERROR           10
#define HDCP_BCAPS_RDY_ERROR    11
#define HDCP_RI_ERROR           12
#define HDCP_UNKNOWN_STATE      0xFF
