...
extern void ta_hdcp_lib_SHA_append_bstatus_M0(struct hdcp_sha_in *sha, uint8_t *bstatus);
extern int ta_hdcp_lib_compute_V(struct hdcp_sha_in *sha);
extern int ta_hdcp_lib_verify_V(struct hdcp_sha_in *sha);
extern int ta_hdcp_lib_check_r0(uint8_t *r0_rx);
...
extern int ta_hdcp_get_ctrl_state(void);
...
#define hdcp_lib_check_r0(arg) ta_hdcp_lib_check_r0(arg)
