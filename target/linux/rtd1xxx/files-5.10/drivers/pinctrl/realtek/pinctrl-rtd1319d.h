...
#ifndef PINCTRL_RTD1319D_H
#define PINCTRL_RTD1319D_H
...
#define DECLARE_RTD1319D_PIN(_pin, _name) static const unsigned int rtd1319d_## _name ##_pins[] = { _pin }
...
static const struct rtd_pin_config_desc rtd1319d_iso_configs[] = {
	[RTD1319D_ISO_SCAN_SWITCH] = RTK_PIN_CONFIG(scan_switch, 0x2c, 0, PCONF_UNSUPP, PCONF_UNSUPP, 0, 1, 2, PADDRI_4_8),
	...
	[RTD1319D_ISO_USB_CC2] = RTK_PIN_CONFIG(usb_cc2, 0x34, 20, PCONF_UNSUPP, PCONF_UNSUPP, 0, 1, 2, PADDRI_4_8),
	...
	[RTD1319D_ISO_USB_CC1] = RTK_PIN_CONFIG(usb_cc1, 0x38, 10, PCONF_UNSUPP, PCONF_UNSUPP, 0, 1, 2, PADDRI_4_8),
	...
	[RTD1319D_ISO_BOOT_SEL] = RTK_PIN_CONFIG(boot_sel, 0x38, 23, 0, 1, PCONF_UNSUPP, 2, 3, PADDRI_4_8),
	[RTD1319D_ISO_RESET_N] = RTK_PIN_CONFIG(reset_n, 0x38, 27, 0, 1, PCONF_UNSUPP, 2, 3, PADDRI_4_8),
	[RTD1319D_ISO_TESTMODE] = RTK_PIN_CONFIG(testmode, 0x3c, 0, 0, 1, PCONF_UNSUPP, 2, 3, PADDRI_4_8),
	[RTD1319D_ISO_GPIO_40] = RTK_PIN_CONFIG(gpio_40, 0x3c, 4, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1319D_ISO_GPIO_41] = RTK_PIN_CONFIG(gpio_41, 0x3c, 17, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1319D_ISO_GPIO_42] = RTK_PIN_CONFIG(gpio_42, 0x40, 0, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1319D_ISO_GPIO_43] = RTK_PIN_CONFIG(gpio_43, 0x40, 13, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1319D_ISO_GPIO_44] = RTK_PIN_CONFIG(gpio_44, 0x44, 0, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1319D_ISO_GPIO_45] = RTK_PIN_CONFIG(gpio_45, 0x44, 13, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1319D_ISO_EMMC_DATA_0] = RTK_PIN_CONFIG(emmc_data_0, 0x48, 0, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1319D_ISO_EMMC_DATA_1] = RTK_PIN_CONFIG(emmc_data_1, 0x48, 13, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1319D_ISO_EMMC_DATA_2] = RTK_PIN_CONFIG(emmc_data_2, 0x4c, 0, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1319D_ISO_EMMC_DATA_3] = RTK_PIN_CONFIG(emmc_data_3, 0x4c, 13, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1319D_ISO_EMMC_DATA_4] = RTK_PIN_CONFIG(emmc_data_4, 0x50, 0, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1319D_ISO_EMMC_DATA_5] = RTK_PIN_CONFIG(emmc_data_5, 0x50, 13, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1319D_ISO_EMMC_DATA_6] = RTK_PIN_CONFIG(emmc_data_6, 0x54, 0, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1319D_ISO_EMMC_DATA_7] = RTK_PIN_CONFIG(emmc_data_7, 0x54, 13, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1319D_ISO_EMMC_DD_SB] = RTK_PIN_CONFIG(emmc_dd_sb, 0x58, 0, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1319D_ISO_EMMC_RST_N] = RTK_PIN_CONFIG(emmc_rst_n, 0x58, 13, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1319D_ISO_EMMC_CMD] = RTK_PIN_CONFIG(emmc_cmd, 0x5c, 0, 0, 1, PCONF_UNSUPP, 2, 13, PCONF_UNSUPP),
	[RTD1319D_ISO_EMMC_CLK] = RTK_PIN_CONFIG(emmc_clk, 0x5c, 14, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1319D_ISO_GPIO_80] = RTK_PIN_CONFIG(gpio_80, 0x60, 0, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1319D_ISO_GPIO_78] = RTK_PIN_CONFIG(gpio_78, 0x60, 13, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1319D_ISO_GPIO_79] = RTK_PIN_CONFIG(gpio_79, 0x64, 0, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1319D_ISO_GPIO_81] = RTK_PIN_CONFIG(gpio_81, 0x64, 13, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	...
	[RTD1319D_ISO_HIF_EN] = RTK_PIN_CONFIG(hif_en, 0x74, 0, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1319D_ISO_HIF_DATA] = RTK_PIN_CONFIG(hif_data, 0x74, 13, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1319D_ISO_GPIO_33] = RTK_PIN_CONFIG(gpio_33, 0x78, 0, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1319D_ISO_GPIO_32] = RTK_PIN_CONFIG(gpio_32, 0x78, 13, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1319D_ISO_HIF_CLK] = RTK_PIN_CONFIG(hif_clk, 0x7c, 0, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1319D_ISO_HIF_RDY] = RTK_PIN_CONFIG(hif_rdy, 0x7c, 13, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
