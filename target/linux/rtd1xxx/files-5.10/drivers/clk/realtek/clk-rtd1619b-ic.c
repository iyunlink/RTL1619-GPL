...
static struct clk_gate_data ic_gates[] = {
	...
	GATE(RTD1619B_ISO_CLK_EN_I2C0, "i2c0", NULL, 0x8c, 9),
	GATE(RTD1619B_ISO_CLK_EN_I2C1, "i2c1", NULL, 0x8c, 10),
...
core_initcall(rtd1619b_ic_init);
MODULE_DESCRIPTION("Reatek RTD1619B ISO Controller Driver");
