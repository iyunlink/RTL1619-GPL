...
static struct clk_gate_data ic_gates[] = {
	...
	GATE(RTD1295_ISO_CLK_EN_UR0, "ur0", NULL, 0x8C, 8),
	GATE(RTD1295_ISO_CLK_EN_I2C0, "i2c0", NULL, 0x8C, 9),
	GATE(RTD1295_ISO_CLK_EN_I2C1, "i2c1", NULL, 0x8C, 10),
